    ...
    return (
       <div className='justify-center flex items-center py-20'>
         <div className='text-white grid lg:grid-cols-3 grid-cols-1 overflow-hidden'>
          <div className='px-2' >
          <div className="box bg-[#010D50] my-4 m-auto flex-col  px-5 flex justify-center items-baseline   rounded-lg h-[295px] w-[399px]" data-aos="fade-right" >
            ...
            <p className='text-[16px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Feugiat nulla suspendisse tortor aene.</p>
                ...
                <div className="box bg-[#010D50] my-4 m-auto flex-col  px-5 flex justify-center items-baseline   rounded-lg h-[295px] w-[399px]" data-aos="fade-up-left">
            <button className='bg-blue-700 px-4 py-3 my-5 shadow-lg rounded-lg '>
                <TbWallet />
            </button>
          ...
          <h4 className='text-[18px] font-bold pb-3 uppercase'>iOS & Android App </h4>
            ...
            <div className=''>
            <div className="box bg-[#010D50] my-4 m-auto flex-col  px-5 flex justify-center items-baseline   rounded-lg h-[295px] w-[399px]" data-aos="fade-left" >
            <button className='bg-blue-700 px-4 py-3 my-5 shadow-lg rounded-lg '>
                <TbChartBar />
            </button>
            ...
            <div className="box bg-[#010D50] my-4 m-auto flex-col  px-5 flex justify-center items-baseline   rounded-lg h-[295px] w-[399px]" data-aos="fade-up-right">
            <button className='bg-blue-700 px-4 py-3 my-5 shadow-lg rounded-lg '>
                <BsArrowRepeat />
            </button>
